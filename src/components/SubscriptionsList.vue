                    ...
                    <table class="table align-middle">
                        <thead>
                            <tr>
                                ...
                                <th>Amount</th>
                                <th>Frequency</th>
                                <th>Year Started</th> <!-- New Column for Year Started -->
                                <th>Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="subscription in Subscriptions" :key="subscription.key">
                                ...
                                <td>{{ subscription.yearStarted || 'N/A' }}</td> <!-- Display Year Started -->
                                <td>
            ...
            snapshotChange.forEach((doc) => {
                if (doc.data().name) {
                    this.Subscriptions.push({
                        ...
                        yearStarted: doc.data().yearStarted // Fetch and store yearStarted
                    })
                }
            })
        })
